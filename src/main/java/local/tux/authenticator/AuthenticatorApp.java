package local.tux.authenticator;

import local.tux.authenticator.config.ApplicationProperties;
import local.tux.authenticator.config.DefaultProfileUtil;
...
public class AuthenticatorApp {
    ...
    public AuthenticatorApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AuthenticatorApp.class);
