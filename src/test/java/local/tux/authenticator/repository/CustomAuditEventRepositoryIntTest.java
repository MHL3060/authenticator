package local.tux.authenticator.repository;

import local.tux.authenticator.AuthenticatorApp;
import local.tux.authenticator.config.Constants;
import local.tux.authenticator.config.audit.AuditEventConverter;
import local.tux.authenticator.domain.PersistentAuditEvent;
...
import static local.tux.authenticator.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
