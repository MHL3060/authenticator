package local.tux.authenticator.web.rest;

import local.tux.authenticator.config.Constants;
import local.tux.authenticator.AuthenticatorApp;
import local.tux.authenticator.domain.Authority;
import local.tux.authenticator.domain.PersistentToken;
import local.tux.authenticator.domain.User;
import local.tux.authenticator.repository.AuthorityRepository;
import local.tux.authenticator.repository.PersistentTokenRepository;
import local.tux.authenticator.repository.UserRepository;
import local.tux.authenticator.security.AuthoritiesConstants;
import local.tux.authenticator.service.MailService;
import local.tux.authenticator.service.dto.UserDTO;
import local.tux.authenticator.web.rest.errors.ExceptionTranslator;
import local.tux.authenticator.web.rest.vm.KeyAndPasswordVM;
import local.tux.authenticator.web.rest.vm.ManagedUserVM;
import local.tux.authenticator.service.UserService;
...
@SpringBootTest(classes = AuthenticatorApp.class)
